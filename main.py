...
<body>
    ...
    <script>
        function kirimWA() {
            ...
            statusBox.innerText = "â³ Membuka WhatsApp...";
...
if __name__ == '__main__':
    print("\nðŸŒ Web Dashboard Berhasil Diperbarui!")
    print("ðŸ‘‰ Silakan buka kembali di browser HP kamu: http://127.0.0.1:5000\n")
